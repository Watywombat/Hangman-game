...
# Charger les images
test_surface = pygame.image.load('prre pool day08/hangman/Sans titre.png')
test_surface = pygame.transform.scale(test_surface, (600, 600))

win = pygame.image.load('prre pool day08/hangman/you-win-video-game-vector.jpg')
win = pygame.transform.scale(win, (600, 600))
lose = pygame.image.load('prre pool day08/hangman/you  win titre.png')
lose = pygame.transform.scale(lose, (600, 600))
button = pygame.image.load('prre pool day08/hangman/215-2155436_png-file-svg-cross-mark-png-black.png')
...
def drawman(screen, x, y, penalty):
    if penalty > 0:
        hat =pygame.image.load('prre pool day08/hangman/pixel-art-style-18-bit-style-straw-hat-vector.jpg')
        hat.blit(hat,[x,y-10])
...
def drawmenu(surface):
    start = pygame.image.load('prre pool day08/hangman/EKb5.png')
